...
#pragma region Windows Form Designer generated code
	...
	/// </summary>
	void Level1::InitializeComponent(void)
	{
		...
		this->btnChoice2->Click += gcnew System::EventHandler(this, &Level1::btnChoice2_Click);
		// 
		// btnChoice3
		// 
		...
		this->btnChoice3->Click += gcnew System::EventHandler(this, &Level1::btnChoice3_Click);
		// 
		// btnChoice1
		// 
		...
		this->btnChoice1->Click += gcnew System::EventHandler(this, &Level1::btnChoice1_Click);
		// 
		// picboxLevel1
		// 
		this->picboxLevel1->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Left)
			| System::Windows::Forms::AnchorStyles::Right));
		this->picboxLevel1->BorderStyle = System::Windows::Forms::BorderStyle::Fixed3D;
		this->picboxLevel1->Location = System::Drawing::Point(7, 12);
		this->picboxLevel1->Name = L"picboxLevel1";
		this->picboxLevel1->Size = System::Drawing::Size(283, 319);
		this->picboxLevel1->SizeMode = System::Windows::Forms::PictureBoxSizeMode::StretchImage;
		this->picboxLevel1->TabIndex = 8;
...
#pragma endregion
System::Void Level1::Level1_Load(System::Object^ sender, System::EventArgs^ e) {
	...
	if (text == "Black") {
		lbColor->ForeColor = System::Drawing::SystemColors::ControlLightLight;
	}
	...
	// Putting a color in a picture box
	// The same color as the text
	if (text == colors[0]) {
		picboxLevel1->Image = gcnew Bitmap("C:\\Colors\\Black");
		/*//			FileStream fs = new System.IO.FileStream(@"Images\a.bmp", FileMode.Open, FileAccess.Read);
		//		    pictureBox1.Image = Image.FromStream(fs);
		//			fs.Close();
					//picboxLevel1.Image = Image.FromFile("");
					//PictureBox1.Image = Image.FromFile(“C:\Users\Toshiba\Pictures\sporetrip2014\fish.jpg”)*/
	}
	else if (text == colors[1]) {
		picboxLevel1->Image = gcnew Bitmap("C:\\Colors\\Blue");
	}
	else if (text == colors[2]) {
		picboxLevel1->Image = gcnew Bitmap("C:\\Colors\\Brown");
	}
	else if (text == colors[3]) {
		picboxLevel1->Image = gcnew Bitmap("C:\\Colors\\Green");
	}
	else if (text == colors[4]) {
		picboxLevel1->Image = gcnew Bitmap("C:\\Colors\\Grey");
	}
	else if (text == colors[5]) {
		picboxLevel1->Image = gcnew Bitmap("C:\\Colors\\Orange");
	}
	else if (text == colors[6]) {
		picboxLevel1->Image = gcnew Bitmap("C:\\Colors\\Pink");
	}
	else if (text == colors[7]) {
		picboxLevel1->Image = gcnew Bitmap("C:\\Colors\\Purple");
	}
	else if (text == colors[8]) {
		picboxLevel1->Image = gcnew Bitmap("C:\\Colors\\Red");
	}
	else if (text == colors[9]) {
		picboxLevel1->Image = gcnew Bitmap("C:\\Colors\\Yellow");
	}
	// For the other 2 buttons choices
	// Check if the 1st button is Empty
	if (btnChoice1->Text == " ") {
		int no = rand() % 11;
		//while (colors[no] == text || gcnew String(colors[no].data()) == btnChoice2->Text || gcnew String(colors[no].data()) == btnChoice3->Text) {
...
System::Void Level1::btnChoice1_Click(System::Object^ sender, System::EventArgs^ e) {
	if (lbColor->Text == btnChoice1->Text) {
		trueAnswers++;
		this->Hide();
		Level2^ obj1 = gcnew Level2();
		obj1->ShowDialog();
	}
	else {
		FalseAnswers++;
...
System::Void Level1::btnChoice2_Click(System::Object^ sender, System::EventArgs^ e) {
...
System::Void Level1::btnChoice3_Click(System::Object^ sender, System::EventArgs^ e) {
